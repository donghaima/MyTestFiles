 ...
 * provide this because libevent expects it, but we dont use it.
 */
void
...
buffered_on_error(struct bufferevent *bev, short what, void *arg)
{
        ...
        if (what & EVBUFFER_EOF) {
                ...
                warn("Client socket error, disconnecting.n");
        }
...
on_accept(int fd, short ev, void *arg)
{
        ...
        /* Weve accepted a new client, create a client object. */
         ...
         * dont actually have to do anything in this callback.
         *
        ...
        printf("Accepted connection from %sn",
